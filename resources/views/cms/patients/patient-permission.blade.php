                                    ...
                                    <td>
                                        <div class="form-group clearfix">
                                            <div class="icheck-success d-inline">
                                                <input type="checkbox"
                                                    onchange="UpdatePatientPermission({{$permission->id}})"
                                                    id="permission_{{$permission->id}}" @if ($permission->assignd)
                                                checked @endif>
...
<script>
    function UpdatePatientPermission(permissionId){
        axios.put('/cms/admin/patients/{{$patient->id}}/permissions/edit',{
