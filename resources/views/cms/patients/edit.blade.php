            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">{{__('cms.edit_patient')}}</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="create-form">
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-4">
                                ...
                                <select class="form-control gender" style="width: 100%;" id="gender" name="gender">
                                    <option value="M" @if ($patient->gender == 'M') selected @endif>{{__('cms.male')}}
                                    </option>
                                    <option value="F" @if ($patient->gender == 'F') selected @endif>{{__('cms.female')}}
                                    </option>
                                </select>
                            </div>
                            <div class="form-group col-12">
                                <div
                                    ...
                                    <input type="checkbox" class="custom-control-input" id="active_cheakbox"
                                        name="active" @if ($patient->active) checked @endif>
